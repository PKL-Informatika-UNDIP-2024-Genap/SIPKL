<div class="modal fade" id="modal-detail-mhs" tabindex="-1" data-bs-focus="false" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="content-modal mt-0">
          <table class="table table-hover">
            <tbody>
              ...
              <tr>
                <td class="text-nowrap px-0" style="width: 15%"><strong>No. WA</strong></td>
                <td style="white-space: nowrap; width: 1%">:</td>
                <td id="data-no-wa"></td>
              </tr>
              <tr>
                <td class="text-nowrap px-0" style="width: 15%"><strong>Email</strong></td>
                <td style="white-space: nowrap; width: 1%">:</td>
                <td id="data-email"></td>
              </tr>
              <tr>
